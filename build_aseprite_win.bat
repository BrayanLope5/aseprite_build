...
REM this assumes we are using Visual Studio 2022.
REM VisualStudioSetup.exe is the name of the installer.
REM use "C:\Program Files (x86)\Microsoft Visual Studio\2019\Community" for 2019 version.
VisualStudioSetup.exe --installPath "C:\Program Files\Microsoft Visual Studio\2022\Community" ^
...
curl -L -o skia.zip https://github.com/aseprite/skia/releases/download/m96-2f1f21b8a9/Skia-Windows-Release-x64.zip
mkdir skia
